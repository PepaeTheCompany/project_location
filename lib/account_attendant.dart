...
class account_attendant extends StatefulWidget {
  FirebaseDatabase database = new FirebaseDatabase();
  final FirebaseUser user;
  account_attendant(this.user, {Key key}) : super(key: key);

  @override
  _MySignUpPageState createState() => _MySignUpPageState();
}

class _MySignUpPageState extends State<account_attendant> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("แก้ไขข้อมูลผู้ดูแล", style: TextStyle(color: Colors.white)),
